...
const Courses = () => {
  ...
  const filteredCourses = courses.filter(course => {
    ...
    const matchesYear =
      selectedYear === 'All Years' || course.academicYear === selectedYear;
              ...
              <div className="flex items-center bg-[#3A3A3A] rounded-lg p-1">
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                    viewMode === 'grid' ? 'bg-[#FFC20E] text-[#231F20]' : 'text-[#A5A8AB] hover:text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                    viewMode === 'matrix' ? 'bg-[#FFC20E] text-[#231F20]' : 'text-[#A5A8AB] hover:text-white'
                  }`}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="glass-card p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Search */}
              <div>
                <label className="text-xs font-medium text-[#6B6B6B] mb-2 block">Search Courses</label>
              ...
              {/* Department */}
              <div>
                <label className="text-xs font-medium text-[#6B6B6B] mb-2 block">Department</label>
                <select
              ...
              {/* Academic Year */}
              <div>
                <label className="text-xs font-medium text-[#6B6B6B] mb-2 block">Academic Year</label>
                <select
                  value={selectedYear}
