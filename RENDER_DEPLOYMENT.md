...
8. **Environment Variables** (click "Add Environment Variable"):
   ...
   # CORS - Allow frontend
   CORS_ALLOWED_ORIGINS=https://soas-frontend.onrender.com
   ```
...
6. **Add Environment Variable**:
   ```
   VITE_API_URL=https://soas-backend.onrender.com/api
   ```
...
1. Visit: `https://soas-frontend.onrender.com`
2. Check backend at: `https://soas-backend.onrender.com/api/`
3. Admin panel: `https://soas-backend.onrender.com/admin/`
